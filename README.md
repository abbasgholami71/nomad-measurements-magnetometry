# measurements-magnetometry

NOMAD plugin for magnetometry measurements
...
```sh
git clone https://github.com/abbasgholami71/measurements-magnetometry.git
cd measurements-magnetometry
